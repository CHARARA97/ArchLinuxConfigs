...
SmartPanel {
  ...
  panelContent: Item {
    ...
    readonly property real contentPreferredHeight: (root.compactMode ? 240 : (root.showAlbumArt ? 630 : 300)) * Style.uiScaleRatio
      ...
      NBox {
        ...
        GridLayout {
          ...
          Item {
            ...
            Layout.preferredHeight: root.compactMode ? Math.round(110 * Style.uiScaleRatio) : (root.showAlbumArt ? parent.width : 0)
